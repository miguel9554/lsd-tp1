##################################################
### Estimar la capacidad de entrada de un inversor
##################################################
...
nombre_simulacion = "test_capacidad_entrada_inversor_lento.txt"
...
###### Fall time
with open('fall_time_Cin_inversor.txt') as csvfile:
